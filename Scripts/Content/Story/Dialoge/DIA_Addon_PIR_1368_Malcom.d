...
func void DIA_Addon_Malcom_EXIT_Info()
{
	...
	{
		AI_Output(self, other, "DIA_Addon_Malcom_perm_04_01"); //Lass dich nicht von den Biestern fressen. Die Gegend hier ist sehr gefï¿½hrlich.
	}
	else
	{
		...
		AI_Output(self, other, "DIA_Addon_Malcom_Lager_04_04"); //Die Bï¿½ume hier sind verdammt hartnï¿½ckig.
		AI_Output(self, other, "DIA_Addon_Malcom_Lager_04_05"); //Er wird noch eine Weile auf sein Holz warten mï¿½ssen. Sag ihm das.
...
{
	AI_Output(other, self, "DIA_Addon_Malcom_WasMachen_15_00"); //Beschï¿½ftigt?
	AI_Output(self, other, "DIA_Addon_Malcom_WasMachen_04_01"); //Hï¿½r bloï¿½ auf. Henry will, dass ich hier die ganzen Bï¿½ume abholze.
	if (Henry.aivar[AIV_TalkedToPlayer] == FALSE)
	{
		AI_Output(other, self, "DIA_Addon_Malcom_WasMachen_15_02"); //Henry?
		AI_Output(self, other, "DIA_Addon_Malcom_Add_04_00"); //Er fï¿½hrt unseren Trupp an.
	};

	AI_Output(self, other, "DIA_Addon_Malcom_WasMachen_04_04"); //Er steht die ganze Zeit vor unserm Lager und hï¿½lt groï¿½e Reden.
	AI_Output(self, other, "DIA_Addon_Malcom_WasMachen_04_05"); //Mehr Einsatz fï¿½r die Gemeinschaft und so'n Dreck.
	AI_Output(self, other, "DIA_Addon_Malcom_WasMachen_04_06"); //Dabei macht er selber keinen Finger krumm.
};

// ************************************************************
// 					Holz - Nachricht fï¿½r Henry
// ************************************************************
instance DIA_Addon_Malcom_Entertrupp(C_INFO)
{
	...
	description		= "Henry ist euer Anfï¿½hrer?";
};
...
{
	AI_Output(other, self, "DIA_Addon_Malcom_Entertrupp_15_00"); //Henry ist euer Anfï¿½hrer?
	AI_Output(self, other, "DIA_Addon_Malcom_WasMachen_04_03"); //Ja, der Anfï¿½hrer von unserem Entertrupp.
	AI_Output(self, other, "DIA_Addon_Malcom_Add_04_01"); //Unser Kï¿½PT'N ist Greg.
	if (GregIsBack == FALSE)
	{
